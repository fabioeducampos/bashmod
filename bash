...
# * System: BackBox 14.04.1-Ubuntu	 					    *=
# * local: /home/user/.bashrc 							    *=
# * 										    *= 
# * Author: jamesblack "Hat00Xd@hat266" Dark00 						    *=
# * E-Mail: jamesblack@ 							    *=
# * Date: 2016-20-11 								    *=
# ***********************************************************************************=
#=====================================================================================
...
#===============================================================================
echo -e "$BG================================================================================
			*** Hora do Brasil e Servidores: *** $BG
================================================================================"
ntpq -p										
echo '================================================================================'
echo -e "$BG						     		 
      [*] Starting FSoceity00.dat Console... `date`
================================================================================"
echo -e "$BB			  ® SKULL_HUNTERS ®" "$BG[→ON←]"
echo -e "$BW        *** PRONTO, OK, EIS SEU TERMINAL, DIGITE SEU COMANDO: ***
================================================================================"
...
#=====================================================================================
		...
		## CARREGANDO
		#python carregando.py

#=====================================================================================
PS1="$G┌─[$BR\u$G]$BY@$G[$BW${HOSTNAME%%.*}$G]$G:༒\n$BC└──>$BR \\$ $NONE"
...
#=====================================================================================		
PS1="$BR┍━[$BG\u$BR]$BY@$BR[$BW${HOSTNAME%%.*}$BR]$BC:\w\n$BR┕━━━━━━━━>$BG \\$ $NONE"
